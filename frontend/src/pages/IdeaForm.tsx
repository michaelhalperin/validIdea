...
import { Sparkles, ArrowRight, Link as LinkIcon, X, Loader2, Lock, ChevronLeft, Target, FileText, Search } from 'lucide-react';
...
export default function IdeaForm() {
      ...
      <div className="max-w-2xl mx-auto text-center pt-12">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">
            You've used all your analysis credits for today. Credits will reset at midnight.
          </p>
          <Link 
            to="/profile" 
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error(err);
      setLoading(false);
      // Consider adding a toast/alert here for user feedback
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      >
        ...
        <p className="text-gray-400">Let AI deconstruct your idea and evaluate its potential.</p>
      </motion.div>
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center max-w-xl mx-auto relative">
          ...
          {[
            ...
            return (
              <div key={s.num} className="flex flex-col items-center gap-2 bg-[#030303] px-2">
                <div 
                ...
                <span className={`text-xs font-medium transition-colors duration-300 ${isCurrent ? 'text-white' : 'text-gray-500'}`}>
                  {s.label}
                </span>
              </div>
            );
      ...
      {/* Card Container */}
      <div className="bg-[#080808] border border-white/5 rounded-3xl p-6 md:p-10 min-h-[400px] relative overflow-hidden shadow-2xl">
        {/* Ambient Background */}
        ...
        <AnimatePresence mode="wait" custom={direction}>
          {step === 1 && (
            ...
            >
              <div>
                <h2 className="text-xl font-bold text-white mb-1">What's your idea called?</h2>
                <p className="text-sm text-gray-400 mb-6">Give it a working title. You can change this later.</p>
                <input
                  autoFocus
                  type="text"
                  value={title}
                  onChange={(e) => setTitle(e.target.value)}
                  onKeyDown={(e) => e.key === 'Enter' && title && oneLiner && nextStep()}
              ...
              <div>
                <h2 className="text-xl font-bold text-white mb-1">The Elevator Pitch</h2>
                <p className="text-sm text-gray-400 mb-6">Explain it in one sentence. What is it and who is it for?</p>
                <input
                  type="text"
                  value={oneLiner}
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-400 mb-6">
                  The more details you provide, the better the AI analysis. Describe the problem, your solution, 
                  features, target audience, and revenue model.
                </p>
                <textarea
                  autoFocus
                  value={description}
          ...
          {step === 3 && (
            ...
            >
              <div>
                <h2 className="text-xl font-bold text-white mb-1">Context & Attachments</h2>
                <p className="text-sm text-gray-400 mb-6">
                  Add links to pitch decks, competitor websites, or inspiration (optional).
                </p>
                ...
                <div className="flex flex-wrap gap-3 min-h-[100px]">
                  ...
                  {attachmentUrls.map((url) => (
                    ...
                    >
                      ...
                      <button 
                        onClick={() => setAttachmentUrls(urls => urls.filter(u => u !== url))}
              ...
              <div className="flex justify-between items-center pt-8 border-t border-white/5">
                ...
                <button 
                  ...
                  disabled={loading}
                  className="btn-primary w-48 flex items-center justify-center gap-2 py-3 text-lg shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] transition-all"
                >
